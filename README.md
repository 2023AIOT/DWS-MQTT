...
Plots are generated by the plotting functions in `RUN_EXPERIMENTS.py`. Commit
raw and processed measurement exports together with the figures for the tagged
paper release; do not treat broker databases or PNG files alone as raw data.
